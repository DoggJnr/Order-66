...
bool PlayerCreationManager::createCharacter(ClientCreateCharacterCallback* callback) {
	...
	box->setPromptTitle("Welcome To Order 66");
	box->setPromptText("Welcome to SWG Order 66, please read the forums for latest changes.");
	//Broadcast to Server
	String playerName = playerCreature->getFirstName();
	StringBuffer zBroadcast;
	zBroadcast << "\\#00ace6" << playerName << " \\#ffb90f Has Joined The Order 66  Server!";
